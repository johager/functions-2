...
const each = (names, callback) => names.forEach((name, i) => callback(name, i))
...
each(names, (name, i) => {
  console.log('The item at index', i, `is ${name}.`)
})
...
console.log("addTen(15):", addTen(15))
...
const addFavNum = addingFactory(7);

console.log("addFavNum(7):", addFavNum(7));